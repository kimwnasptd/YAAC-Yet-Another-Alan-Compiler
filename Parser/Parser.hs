...
happyExpList = Happy_Data_Array.listArray (0,40) ([0,0,64,0,0,1,0,0,0,0,0,0
	])
...
happyReduction_2 (HappyTerminal (TName           happy_var_1))
	 =  HappyAbsSyn5
		 (LV_Var  happy_var_1
	)
...
happyReduction_4 (HappyTerminal (TStringLiteral  happy_var_1))
	 =  HappyAbsSyn5
		 (LV_Lit  happy_var_1
	)
